	...
	<div>
		<div class="container">
			...
			<el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
				...
				<el-table-column prop="text" width="350" label="内容" align="center"></el-table-column>
		...
		<el-dialog title="查看通知详情" v-model="visible1" width="600px" destroy-on-close>
...
import { deleteNoticeApi, getNoticeList } from '../api/notice';
import TableEdit from '../components/notice/table-edit.vue';
import TableDetail from '../components/notice/table-detail.vue';
...
const handleDelete = (index: number) => {
	...
	ElMessageBox.confirm('确定要删除吗？', '提示', {
		...
		.then(() => {
			deleteNoticeApi(tableData.value[index].id).then(res => {
