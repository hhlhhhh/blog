...
import TableEdit from '../components/user/table-edit.vue';
import TableDetail from '../components/user/table-detail.vue';
...
const handleDelete = (index: number) => {
	...
	ElMessageBox.confirm('确定要删除吗？', '提示', {
		...
		.then(() => {
			deleteUserApi(tableData.value[index].id).then(res => {
